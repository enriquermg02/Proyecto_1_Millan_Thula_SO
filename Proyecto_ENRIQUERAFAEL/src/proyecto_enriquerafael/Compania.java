...
public class Compania {
    ...
    public Compania(Interfaz inter, Drive drive, Recursos recursos,Semaphore mutex) {
        this.inter = inter;
    ...
    public void crearhilosfijos(){
        ...
        dev3.start();
        Developer dev4 = new Developer(3, 1, drive,mutex,recursos);
        dev4.start();
        Developer dev5 = new Developer(4, 5, drive,mutex,recursos);
        dev5.start();
